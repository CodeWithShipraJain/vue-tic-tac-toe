<template>
  <div id="app">
    ...
    <div class="modal fade app-modal" tabindex="-1" role="dialog"
      ...
      <div class="modal-dialog modal-size">
        <div class="modal-content">
          ...
          <div class="content body">
            ...
            <br><strong><em>I'M SMARTER THAN YOU! HA-HA-HA!!!</em></strong> <br>
            Wana try me? Chose : <br>
            <div class="center-block symbol-options">
              <button
                class="symbol-option btn btn-default btn-md"
                data-dismiss="modal">
                X
              </button> OR <button
                class="symbol-option btn btn-default btn-md"
